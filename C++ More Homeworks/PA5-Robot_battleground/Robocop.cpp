...
Robocop::Robocop() : Humanic(2,30,40,"defaultrobocop") {

}
Robocop::Robocop(World* wrld, int x,int y,string name) : Humanic(wrld,x,y,2,30,40,name) {
...
int Robocop::getIntType() {
    return ROBOCOP;
}
int Robocop::getDamage() {
    return Humanic::getDamage(); // Call and get damage points from Humanic class function and return it
}

int Robocop::move(int& a,int& b) {
